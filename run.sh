...
sed -i "s|jdbc:mysql://127.0.0.1:3306/${AIRPAL_DB_NAME}|jdbc:mysql://${MYSQL_PORT_3306_TCP_ADDR}:${MYSQL_PORT_3306_TCP_PORT}/${AIRPAL_DB_NAME}|g" /airpal-master/reference.yml
